...
@updated 2025.06.09 5:16 PM ET - Implemented complete JWT authentication with login endpoint
...
from app.models.auth import LoginRequest, LoginResponse, ErrorResponse
from app.services.auth_service import authenticate_user, create_access_token, get_current_user_from_token
