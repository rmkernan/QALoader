...
export const NAV_ITEMS = [
  ...
  { id: View.LOADER, label: "Load from Markdown", icon: 'M9.25 13.25a.75.75 0 001.5 0V4.636l2.955 3.129a.75.75 0 001.09-1.03l-4.25-4.5a.75.75 0 00-1.09 0l-4.25 4.5a.75.75 0 101.09 1.03L9.25 4.636v8.614z M3.5 12.75a.75.75 0 00-1.5 0v2.5A2.75 2.75 0 004.75 18h10.5A2.75 2.75 0 0018 15.25v-2.5a.75.75 0 00-1.5 0v2.5c0 .69-.56 1.25-1.25 1.25H4.75c-.69 0-1.25-.56-1.25-1.25v-2.5z' },
  { id: View.CURATION, label: "Manage Content", icon: 'M10 3.75a2 2 0 100 4 2 2 0 000-4zM4.167 6.375a.625.625 0 01.625-.625h10.416a.625.625 0 010 1.25H4.792a.625.625 0 01-.625-.625zM4.167 11.375a.625.625 0 01.625-.625h10.416a.625.625 0 010 1.25H4.792a.625.625 0 01-.625-.625zM10 13.75a2 2 0 100 4 2 2 0 000-4z' },
];
